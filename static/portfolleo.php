...
/*
	...
	Description: Portfolleo is a Simple, Intuitive Portfolio Plugin for Wordpress.
	Version: 1.0
		...
		if ($wpdb->get_var("SHOW TABLES LIKE '$table_name'") != $table_name)
		{
			...
			} else if ($_POST['desc'] == "" || $_POST['desc'] == " ")
			{
				...
				foreach ($portfolio_curr->find('div[id=slidesContainer]') as $slidesContainer)
				{
					...
					$update = "UPDATE ". $table_name ." SET post_content = '<span class=\"control\" id=\"rightControl\">right</span><span class=\"control\" id=\"leftControl\">left</span>". $slidesContainer ."' WHERE post_name = 'portfolio'";
					$wpdb->query( $update );
					$_SESSION['added'] = TRUE;	
